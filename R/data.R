#' Example of NWASC Phase 1 CTS Tranect Data
#'
#' A daset example of a cleaned up query of phase 1 transect information
...
#'   \item{transect_id}{Id of transecet}
#'   \item{segmented_transect_id}{source_transect_id from catalog}
#'   \item{transect_width_nb}{width of transect when availiable}
#'   }
...
#'
#' @format A data frame with 37818 rows and 17 varibles
#'
#' @source \url{https://github.com/USFWS/AMAPPS/tree/master/NWASC}
"nwasc.ph1.dts.dat"
...
#' Historic DTS data from NWASC
#'
#' @format A data frame with 372817 rows and 8 varibles
#'
#' @source \url{https://github.com/USFWS/AMAPPS/tree/master/NWASC}
...
#'
#' A daset example of a cleaned up query of phase 1 observation information
#' from the Northwest Atlantic Seabird Catalog
#'
...
#'
#' A daset example of a cleaned up query of phase 1 track information
#' from the Northwest Atlantic Seabird Catalog
#'
