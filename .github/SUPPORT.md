# Getting help with nwasc

Thanks for using nwasc. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/nwasc/issues) to make sure the 
